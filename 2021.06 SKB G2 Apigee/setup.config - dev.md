...
IP1=10.10.214.111          # DS1  
IP2=10.10.214.112          # DS2  
IP3=10.10.214.113          # DS3  
IP4=10.10.214.114          # RMP1  
IP5=10.10.214.115          # RMP2  
IP6=10.10.214.116          # MS, LDAP, UI  
IP7=10.10.214.117          # SAX
```
...
SMTPMAILFROM="agwpoc \<agwpoc@sk.com\>"
```